...
<div class="feature-section">
  <div class="container">
    <div class="text-center" mb-5>
      <h2>รายงานพิกัดสมุนไพรทั้งหมด</h2>
    </div></br>
  </div>
  <br><br>
<div class="container-fluid">
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo "<td>" . $row[6] .  "</td> "; 
        //เมนูดูข้อมูลอัพเดท
        echo "<td><a href='showdatalocationadmin.php?ID=$row[0]'>ดูข้อมูลพิกัด</a> 
        <br></td>  ";


 echo "<td><a href='formdeletelocation.php?AreaID=$row[0]' onclick=\"return confirm('ต้องการลบข้อมูลหรือไม่')\">ลบข้อมูล</a></td> ";
  echo "</tr>";
